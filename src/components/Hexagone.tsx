...
import { useLayoutEffect, useEffect,useRef, type ComponentPropsWithoutRef, useState } from "react"
import { twMerge } from "tailwind-merge"


export const Hexagone = (props:ComponentPropsWithoutRef<'svg'> &{size?:number, reverse?:boolean, duration?:number}) => {
    ...
    return(
        ...
        <svg 
            ...
            className={twMerge("text-pink-500/10 -rotate-6", className)}
            style={{
                height: size,
                width: size,
            }}
        ...
        {totalPathLength && (
            <motion.svg 
                    ...
                    strokeWidth="6"
                    xmlns="http://www.w3.org/2000/svg"
                    className={twMerge("text-pink-500/30 -rotate-6 absolute", className)}
                    initial={{
                        strokeDashoffset: 0,
                    }}
                    animate={{
