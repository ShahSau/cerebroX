            ...
            {cardData.map((card, index) => (
              <div key={index+card.title} className="relative z-0 p-8 md:p-10 max-w-xs md:max-w-md  group">
                ...
                <div className="flex justify-between mt-12">
                  <button className={twMerge(`text-sm font-heading uppercase font-extrabold tracking-wider `, card.color === 'pink' && 'text-pink-500',  card.color === 'lime' && 'text-lime-500', card.color === 'cyan' && 'text-cyan-500', card.color=== 'violet' && 'text-violet-500' )}>Learn More</button>
